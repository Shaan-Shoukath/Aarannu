-- ═══════════════════════════════════════════════════════════════
-- Migration 002: Project Member Delivery Status
-- ═══════════════════════════════════════════════════════════════
--
-- Persists client-side approval delivery progress for project members.
-- Allows the admin dashboard to resume or inspect the last known
-- delivery state even after the browser tab is closed.
--
