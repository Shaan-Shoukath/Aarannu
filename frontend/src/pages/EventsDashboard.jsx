      ...
      <div className="sticky top-0 z-50 bg-white/80 backdrop-blur-md border-b border-slate-200">
        <div className="max-w-7xl mx-auto flex items-center justify-between px-6 py-3">
          ...
          <div className="flex gap-2">
            <button onClick={() => navigate(`/org/${slug}/dashboard`)} className="px-3 py-1.5 text-xs text-slate-500 hover:text-slate-900 hover:bg-slate-100 rounded-lg transition cursor-pointer">
              Dashboard
            </button>
      ...
      <div className="max-w-7xl mx-auto px-6 py-8 space-y-6">
        ...
        {events.length === 0 ? (
          ...
          <div className="grid gap-3">
            {events.map((ev) => (
              <div key={ev.id} className="bg-white border border-slate-200 rounded-xl p-5 hover:shadow-md transition-shadow">
