...
const TEMPLATE_DATA = [
  {
    ...
    description: "Clean geometric design with customizable gradient colors and QR code.",
    bestFor: "General Use",
    tags: ["Horizontal", "Gradient"],
    gradient: null,
    icon: "plus",
  },
  {
    ...
    description: "Professional employee cards with bold brand color and QR support.",
    bestFor: "Companies",
